...
namespace Drupal\agand\Plugin\Field\FieldFormatter;
 ...
 *
 * @FieldFormatter(
 *   id = "pattern_entity_reference_label_formatter",
 *   label = @Translation("Entity label, wrapped in a pattern"),
 *   description = @Translation("Display the referenced entities label wrapped with UI Patterns)."),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
 */
class PatternEntityReferenceLabelFormatter extends EntityReferenceLabelFormatter {
  ...
  public function __construct(
    ...
    UiPatternsManager $patterns_manager,
    UiPatternsSourceManager $source_manager,

...
/**
 * Plugin implementation of the 'pattern_email_mailto' formatter.
 *
 * @FieldFormatter(
 *   id = "pattern_email_mailto",
 *   label = @Translation("Email, wrapped in a pattern"),
 *   field_types = {
 *     "email"
 *   }
 * )
 */
class PatternMailToFormatter extends MailToFormatter {

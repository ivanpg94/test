 ...
 *
 * @MigrateSource(
 *   id = "d7_activity_field_link",
 *   source_module = "node"
 * )
 */
class ActivityFieldLink extends Node {
  ...
  public function query() {
    ...
    $query->join('field_data_field_enlaces', 'e', 'n.nid = e.entity_id');
    $query->fields('e', [
      'delta',
    ]);
  ...
  public function prepareRow(Row $row) {
    ...
    $specific_link = $row->getSourceProperty('field_enlaces')[$row->getSourceProperty('delta')];
    $row->setSourceProperty('link', [$specific_link]);

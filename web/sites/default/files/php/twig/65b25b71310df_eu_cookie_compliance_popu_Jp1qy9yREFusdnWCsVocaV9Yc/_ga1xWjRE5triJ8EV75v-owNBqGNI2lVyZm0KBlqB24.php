...
class __TwigTemplate_825f4534dee696b2f8c200dc51aa30e2 extends Template
{
    private $source;
    private $macros = [];
            ...
            <div>
              <input type=\"checkbox\" name=\"cookie-categories\" class=\"eu-cookie-compliance-category-checkbox\" id=\"cookie-category-";
                ...
                echo "\"
                     ";
                // line 68
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["category"], "checkbox_default_state", [], "any", false, false, true, 68), ["checked", "required"])) {
                    echo " checked ";
                }
                // line 69
                echo "                     ";
